...
<h2>Grande esperienza in edilizia</h2>
    <blockquote cite="">
        &ldquo;Specialmente controsoffitti, gessature, isolamenti, laminati. Grande esperienza di <em>Gestione squadre</em> e lavori di finitura in autonomia.&rdquo; Prova a scaricare il mio <a href="">CV Vitae</a> o passare dal mio <a href="https://it.linkedin.com/in/cristiano-leopardi">profilo LinkedIn</a>
    </blockquote>
        <br>
        <a href="#" class="navigate-down">
            <img width="178" height="238" data-src="https://s3.amazonaws.com/hakim-static/reveal-js/arrow.png" alt="Down arrow">
