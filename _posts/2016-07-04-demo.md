...
<section>
    <h2>Benvenuto</h2>
    <p>
        reveal.js mi permette di poter realizzare per te bellissime ed interattive slideshow utilizzando l'HTML come struttura di base. <a>Per poter rendere professionali al massimo le presentazioni per il tuo business o la tua comunicazione.</a>
    </p>
</section>
