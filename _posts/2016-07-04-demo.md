...
<section>
    <section id="fragments">
        ...
        <p class="fragment">... Per un'altro step ...</p>
        <p><span class="fragment">... a</span> <span class="fragment">Altre Sottosezioni</span> <span class="fragment">slide.</span></p>

        <aside class="notes">
            Questa slide possiede sottosezioni nascoste che si attivano scorrendo o andando avanti.
        </aside>
    </section>
    <section>
