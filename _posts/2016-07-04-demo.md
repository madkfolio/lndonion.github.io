...
<h2>Grande esperienza in edilizia</h2>
    ...
    <section data-background="{{site.baseurl}}/images/wake-up.gif">
        ...
        <p>Sempre in cerca di nuove sfide, motivato e motivante nella vita sociale e lavoro. Grazie hai suoi hobby e sport come arti merziali e snowboard ha il temperamento giusto per primeggiare nel team e creare la giusta gamification per un giusto team building.</p>
        <br>
        <a href="#/2">
            <img width="178" height="238" data-src="https://s3.amazonaws.com/hakim-static/reveal-js/arrow.png" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
...
<section>
    ...
    <section data-background="{{site.baseurl}}/images/tecnologies.png">
        <h2>Snowboard</h2>
