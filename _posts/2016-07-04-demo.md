...
<section>
    <section>
        ...
        <p>Specialmente controsoffitti, gessature, isolamenti, laminati. Grande esperienza di <em>Gestione squadre</em> e lavori di finitura in autonomia.</p>

        <p>Prova a scaricare il mio <a href="">CV Vitae</a> o passare dal mio <a href="https://it.linkedin.com/in/cristiano-leopardi">profilo Linkedin</a>.</p>
        <br>
        <a href="#" class="navigate-down">
            <img width="178" height="238" data-src="https://s3.amazonaws.com/hakim-static/reveal-js/arrow.png" alt="Down arrow">
        </a>
