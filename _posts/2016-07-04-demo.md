...
<section>
    ...
    <section>
        ...
        <br>
        <a href="#/2">
            <img width="178" height="238" data-src="{{site.baseurl}}/images/scroll-down-arrow-icon" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
    </section>
</section>
<section>
