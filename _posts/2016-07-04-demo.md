...
<section>
    <h1>Ciao!</h1>
    <h3>Mi chiamo <a href="https://it.linkedin.com/in/cristiano-leopardi">Cristiano Leopardi</a> e questo è il mio sito di presentazione.</h3>
    <p>
        <small>Gentilmente offerto da <a href="http://antfolio.github.io">Antfolio</a> / <a href="http://twitter.com/lantoniotrento">@lantoniotrento</a>. Su mobile? Puoi scorrere il dito. Su PC? Puoi usare le frecce della tastiera. </small>
    </p>
</section>
...
<section>
    <h2>Benvenuto</h2>
    <p>
        In questa presentazione potrai capire come potrò esserti utile, scaricare il mio CV, darmi la possibilità di farmi conoscere meglio <a href="https://it.linkedin.com/in/cristiano-leopardi">connettendoci insieme su linkedIn</a> e sapere come potrei collaborare al tuo business. Che ne dici?
    </p>
</section>
...
<section>
    <section data-background="{{site.baseurl}}/images/do-this.gif">
        ...
        <a href="#" class="navigate-down">
            <img width="178" height="238" data-src="{{site.baseurl}}/images/scroll-down-arrow-icon.png" alt="Down arrow">
        </a>
    </section>
    <section>
    ...
    <section>
        ...
        <br>
        <a href="#/2">
            <img width="178" height="178" data-src="{{site.baseurl}}/images/scroll-down-arrow-icon.png" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
    </section>
</section>
<section>
...
<h2>Grande esperienza in edilizia</h2>
    <p>
        ...
        <br>
        <a href="#" class="navigate-down">
            <img width="178" height="178" data-src="{{site.baseurl}}/images/scroll-down-arrow-icon.png" alt="Down arrow">
        </a>
    </section>
    <section>
    ...
    <section data-background="{{site.baseurl}}/images/wake-up.gif">
        ...
        <br>
        <a href="#/2">
            <img width="178" height="178" data-src="{{site.baseurl}}/images/scroll-up-arrow-icon.png" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
    </section>
</section>
