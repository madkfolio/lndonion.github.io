...
<section>
    ...
    <section>
        ...
        <br>
        <a href="#/2">
            <img width="100" height="100" data-src="{{site.baseurl}}/images/scroll-down-arrow-icon.png" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
    </section>
</section>
<section>
...
<h2>Grande esperienza in edilizia</h2>
    ...
    <section data-background="{{site.baseurl}}/images/wake-up.gif">
        ...
        <br>
        <a href="#/2">
            <img width="100" height="100" data-src="{{site.baseurl}}/images/scroll-up-arrow-icon.png" alt="Up arrow" style="transform: rotate(180deg); -webkit-transform: rotate(180deg);">
        </a>
    </section>
</section>
